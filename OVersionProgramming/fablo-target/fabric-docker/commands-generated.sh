...
installChaincodes() {
  ...
  if [ -n "$(ls "$CHAINCODES_BASE_DIR/./chaincodes/chaincode-kv-node")" ]; then
    ...
    chaincodeApprove "cli.org1.example.com" "peer0.org1.example.com:7041" "main-channel" "version_cc" "$version" "orderer0.group1.orderer.example.com:7030" "" "false" "" ""
    chaincodeCommit "cli.org1.example.com" "peer0.org1.example.com:7041" "main-channel" "version_cc" "$version" "orderer0.group1.orderer.example.com:7030" "" "false" "" "peer0.org1.example.com:7041" "" ""
  else
  ...
  if [ -n "$(ls "$CHAINCODES_BASE_DIR/./chaincodes/chaincode-kv-node")" ]; then
    ...
    chaincodeBuild "version_cc" "node" "$CHAINCODES_BASE_DIR/./chaincodes/chaincode-kv-node" "16"
    chaincodePackage "cli.org2.example.com" "peer0.org2.example.com:7041" "version_cc" "$version" "node" printHeadline "Installing 'version_cc' for Org2" "U1F60E"
    chaincodeInstall "cli.org2.example.com" "peer0.org2.example.com:7061" "version_cc" "$version" ""
    chaincodeApprove "cli.org2.example.com" "peer0.org2.example.com:7061" "main-channel" "version_cc" "$version" "orderer0.group1.orderer.example.com:7030" "" "false" "" ""
    chaincodeCommit "cli.org2.example.com" "peer0.org2.example.com:7061" "main-channel" "version_cc" "$version" "orderer0.group1.orderer.example.com:7030" "" "false" "" "peer0.org2.example.com:7061" "" ""
  else
    echo "Warning! Skipping chaincode 'version_cc' installation. Chaincode directory is empty."
    echo "Looked in dir: '$CHAINCODES_BASE_DIR/./chaincodes/chaincode-kv-node'"
  fi
  if [ -n "$(ls "$CHAINCODES_BASE_DIR/./chaincodes/chaincode-kv-node-faulty")" ]; then
    ...
    chaincodePackage "cli.org3.example.com" "peer0.org1.example.com:7081" "version_cc" "$version" "node" printHeadline "Installing 'version_cc' for Org3" "U1F60E"
    chaincodeInstall "cli.org3.example.com" "peer0.org3.example.com:7081" "version_cc" "$version" ""
    chaincodeApprove "cli.org3.example.com" "peer0.org3.example.com:7081" "main-channel" "version_cc" "$version" "orderer0.group1.orderer.example.com:7030" "" "false" "" ""
    printItalics "Committing chaincode 'version_cc' on channel 'main-channel' as 'Org1'" "U1F618"
    chaincodeCommit "cli.org3.example.com" "peer0.org3.example.com:7081" "main-channel" "version_cc" "$version" "orderer0.group1.orderer.example.com:7030" "" "false" "" "peer0.org3.example.com:7081" "" ""
  else
    echo "Warning! Skipping chaincode 'version_cc' installation. Chaincode directory is empty."
